...
namespace MedicalModel
{
    public partial class Form1 : Form
    {
        ...
        void DrawMortality(Dictionary<AggStatsType, double[]> agg, bool clear, string Title)
        {
            ...
            if (Title == "Male")
            {
                ChartIt("Train male mortality", SeriesChartType.Line, MortChart, Environment.Params.MaleTrainMortality, x);
            }
            else if (Title == "Female")
            {
                ChartIt("Train female mortality", SeriesChartType.Line, MortChart, Environment.Params.FemaleTrainMortality, x);
            }
